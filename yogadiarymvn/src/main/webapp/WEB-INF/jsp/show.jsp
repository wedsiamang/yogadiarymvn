<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
     <%@ page import ="model.Account,model.Diary,model.Teacher,model.Login,java.util.List" %>
    <%
    Diary day=(Diary)request.getAttribute("day");
...
<title>Edit a day</title>
</head>
<body>

<div class="mx-auto" style="width:300px">
	<h1 class = "mb-3" style="text-align:center">YOGA DIARY</h1>
	<form action="/yogadiarymvn/UpdateServlet" method="post">
	...
	<div class="mb-3">
		...
		<input type="date" class="form-control" id="date" name="date" value="<%=day.getDate()%>">
	...
	<div class="mb-3">
		...
		<div class="mb-3">
			...
			<input type="text" class="form-control" id="condition" name="condition" value="<%=day.getCondition()%>">
		</div>
		...
		<input type="text" class="form-control" id="lunch" name="lunch" value="<%=day.getLunch()%>">
		</div>
		<div class="mb-3">
		<label for="dinner" class="form-label">yesterday's dinner</label>
		<input type="text" class="form-control" id="dinner" name="dinner" value="<%=day.getDinner()%>">
		</div>
		<div class="mb-3">
		<label for="morning" class="form-label">today's morning</label>
		<input type="text" class="form-control" id="morning" name="morning" value="<%=day.getMorning()%>">
		</div>
	<button type="submit" name="id" class="btn regist-btn regist-btn:hover" value="<%=day.getId() %>">UPDATE</button>
	</form>

	<div style="text-align:center;">
		<a class="btn btn--yellow btn--cubic" href="/yogadiarymvn/ListServlet"/>DIARY</a>
		</div>
	</div>
